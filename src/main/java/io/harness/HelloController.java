...
public class HelloController {
    ...
    @GetMapping("/")
    public String home() {
        String projectName = "transactionprocessing";
        String projectDescription = "Securely handles payment authorization, settlement, and reporting in real time using the payment gateway";
